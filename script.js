document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Dr. No': [20, 12, 8, 6, 4, 3, 2, 0],
        'From Russia with Love': [16, 16, 11, 7, 5, 4, 2, 1],
        'Goldfinger': [12, 12, 14, 9, 7, 5, 3, 2],
        'Thunderball': [10, 10, 11, 12, 8, 6, 4, 4],
        'The Spy Who Loved Me': [8, 8, 8, 9, 11, 8, 5, 5],
        'GoldenEye': [6, 6, 7, 7, 8, 10, 7, 5],
        'Casino Royale': [5, 5, 5, 6, 7, 9, 9, 7],
        'Skyfall': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Dr. No', year: '1962' },
        { city: 'From Russia with Love', year: '1963' },
        { city: 'Goldfinger', year: '1964' },
        { city: 'Thunderball', year: '1965' },
        { city: 'The Spy Who Loved Me', year: '1977' },
        { city: 'GoldenEye', year: '1995' },
        { city: 'Casino Royale', year: '2006' },
        { city: 'Skyfall', year: '2012' }
    ];
